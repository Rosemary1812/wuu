...
const heavyAnswer = Array.from({ length: 12 }, (_value, index) => {
  ...
  return [
    ...
    "| path | status | notes |",
    "| --- | --- | --- |",
    `| browser/agent/packages/workbench-ui/src/renderer/App.tsx | changed | resize measurement row ${item} |`,
    `| browser/agent/packages/workbench-ui/src/renderer/styles.css | changed | layout wrapping row ${item} |`,
    "",
    "```ts",
