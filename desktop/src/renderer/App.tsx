...
type ComposerSlashCommandAction =
  ...
  | "no-project"
  | "settings";
type ComposerSlashCommandKind = "prompt" | "action";
...
function parseComposerSlashDraft(value: string): ComposerSlashDraft | undefined {
...
function filterComposerSlashCommands(commands: ComposerSlashCommand[], query: string): ComposerSlashCommand[] {
...
function firstEnabledSlashCommandIndex(commands: ComposerSlashCommand[]): number {
  const index = commands.findIndex((command) => !command.disabledReason);
  return index >= 0 ? index : 0;
}

function nextEnabledSlashCommandIndex(commands: ComposerSlashCommand[], current: number, direction: 1 | -1): number {
...
function composerSlashPrompt(command: ComposerSlashCommand, args: string): string {
...
function createConversationFixture(kind: ConversationFixtureKind, cwd: string, initialized?: InitializeResult): Thread {
  switch (kind) {
    case "rich":
