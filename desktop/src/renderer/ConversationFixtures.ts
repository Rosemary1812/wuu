    ...
    turns: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            status: "completed",
            name: "spawn_agent",
            arguments: `{"name":"inspect_sidebar","description":"检查左侧树","prompt":"验证子 agent 行的视觉和状态","subagent_type":"general-purpose","run_in_background":true}`,
          ...
          },
          {
            ...
            status: "completed",
            name: "spawn_agent",
            arguments: `{"name":"resume_child","description":"子会话恢复","prompt":"确认点击子 agent 后能正常查看会话","subagent_type":"general-purpose","run_in_background":true}`,
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            status: "completed",
            role: "assistant",
            text: "压缩完成后，对话会继续正常显示后续回复。用户能看到的主要变化就是中间这条灰色状态提示；调试面板里也会把它标成“上下文压缩”。",
          },
        ],
      },
    ],
