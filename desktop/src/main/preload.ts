...
const api: WuuDesktopApi = {
  ...
  startTurn: (threadId: string, prompt: string, images, files, permissionMode, mentions) =>
    ipcRenderer.invoke("wuu:turn-start", threadId, prompt, images, files, permissionMode, mentions),
