...
本文面向想理解 Wuu 工作方式的开发者。正文先讲真实行为和使用边界；具体工具名、参数和源码放在最后。它描述的是 Agent 启动的本机进程，不是[子代理协作](../desktop/subagents.md)，也不是按时间触发的 [Automations](../automation/scheduled-tasks.md)。
