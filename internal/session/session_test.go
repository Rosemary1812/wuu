...
func TestHistoryRecordsPersistInSQLite(t *testing.T) {
	...
	if len(all) != 2 || all[1].Role != "meta" || all[1].InputTokens != 12 || all[1].OutputTokens != 4 || all[1].ContextTokens != 14 || all[1].RequestContextTokens != 12 || all[1].CacheCreationTokens != 6 || all[1].CacheReadTokens != 2 {
