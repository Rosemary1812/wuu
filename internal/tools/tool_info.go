...
func classifyToolKind(name string) ToolKind {
	...
	case "list_workflows", "load_workflow", "save_workflow", "list_agent_profiles", "create_agent_profile", "run_workflow", "create_workflow", "workflow_control", "workflow_status":
