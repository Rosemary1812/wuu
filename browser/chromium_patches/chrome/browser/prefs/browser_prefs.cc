...
index 868bfe1564..450513d8aa 100644
...
@@ -1385,6 +1388,8 @@ void RegisterLocalState(PrefRegistrySimple* registry) {
...
@@ -1701,6 +1706,7 @@ void RegisterProfilePrefs(user_prefs::PrefRegistrySyncable* registry,
...
@@ -1776,6 +1782,7 @@ void RegisterProfilePrefs(user_prefs::PrefRegistrySyncable* registry,
...
@@ -2199,6 +2206,10 @@ void RegisterGeminiSettingsPrefs(user_prefs::PrefRegistrySyncable* registry) {
