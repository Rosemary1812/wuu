...
index 84f357ad1e..70793cca97 100644
...
@@ -87,6 +96,28 @@ PinnedActionToolbarButton::PinnedActionToolbarButton(
...
@@ -223,6 +254,30 @@ void PinnedActionToolbarButton::OnMouseReleased(const ui::MouseEvent& event) {
...
@@ -235,7 +290,13 @@ void PinnedActionToolbarButton::UpdateIcon() {
                                     ? icons->touch_icon
                                     : icons->icon;
...
@@ -337,6 +398,26 @@ void PinnedActionToolbarButtonActionViewInterface::ActionItemChangedImpl(
     }
   }
