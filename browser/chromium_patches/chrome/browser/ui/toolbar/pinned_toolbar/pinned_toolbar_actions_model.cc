...
index 205a56f2ab..164bc26f79 100644
...
@@ -245,8 +264,11 @@ void PinnedToolbarActionsModel::MaybeMigrateExistingPinnedStates() {
   if (!CanUpdate()) {
     return;
   }
...
@@ -262,6 +284,36 @@ void PinnedToolbarActionsModel::MaybeMigrateExistingPinnedStates() {
   }
 }
...
@@ -280,3 +332,20 @@ void PinnedToolbarActionsModel::UpdatePref(
