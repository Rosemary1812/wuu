...
index b34a9522e0..1ab1626d99 100644
...
@@ -974,6 +975,19 @@ void ProcessManager::StartTrackingServiceWorkerRunningInstance(
...
@@ -1061,6 +1075,17 @@ void ProcessManager::StopTrackingServiceWorkerRunningInstance(
     return;
   }
