...
const BROWSEROS_INFO = `# Wuu Browser — AI Browser for Local Agents

Wuu Browser is a Chromium-based browser for Wuu. It connects local agent runtime, browser automation, page context, and workspace workflows in one app.

**Project:** https://github.com/blueberrycongee/wuu
...
### Bring Your Own LLM
Connect your preferred AI provider or run models locally. Supported providers include Gemini, Claude/Anthropic, OpenAI, OpenRouter, Ollama, and LM Studio. Configure in Wuu Browser settings.
Learn more: https://github.com/blueberrycongee/wuu

### Scheduled Tasks
Automate tasks on a schedule — daily, hourly, or every few minutes. Runs in a background window without interrupting your work. Use cases: morning briefings, LinkedIn automation, price monitoring. Requires Wuu Browser to be open.
Learn more: https://github.com/blueberrycongee/wuu
...
const TOPIC_SECTIONS: Record<string, { start: string; end?: string }> = {
  overview: { start: '# Wuu Browser', end: '## Core Features' },
  'bring-your-own-llm': {
...
export const browseros_info = defineAssistantTool({
  name: 'browseros_info',
  description:
    'Get information about Wuu Browser features, capabilities, and project links. Use when users ask "What is Wuu Browser?", "What can Wuu Browser do?", or about specific features.',
  input: z.object({
    topic: z
      .enum(VALID_TOPICS)
      .optional()
