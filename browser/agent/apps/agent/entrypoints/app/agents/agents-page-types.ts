...
> = {
  ...
  connecting: {
    ...
    description:
      'Wuu Browser is establishing the OpenClaw control channel for agent operations.',
  },
  reconnecting: {
    badgeVariant: 'secondary',
    ...
    description:
      'The gateway process is up, but Wuu Browser is restoring the control channel.',
  },
  recovering: {
    badgeVariant: 'secondary',
    ...
    description:
      'Wuu Browser detected a control-plane fault and is trying a safe recovery path.',
  },
  disconnected: {
    ...
    description:
      'The gateway process is not available to Wuu Browser right now.',
  },
  failed: {
    ...
    description:
      'Wuu Browser could not restore the OpenClaw control channel automatically.',
  },
}
...
export const FALLBACK_CONTROL_PLANE_COPY = {
  ...
  description:
    'Wuu Browser received a gateway status it does not recognize yet. Refreshing or reconnecting should restore a known state.',
}
...
> = {
  transient_disconnect:
    'The control channel dropped briefly and Wuu Browser is retrying it.',
  signature_expired:
    'The gateway rejected the signed device handshake because its clock drifted.',
  pairing_required:
    'The gateway asked Wuu Browser to approve its local device identity again.',
  token_mismatch:
    'Wuu Browser had to reload the gateway token before reconnecting.',
  container_not_ready:
    'The OpenClaw gateway process is not ready yet, so control-plane recovery cannot start.',
  unknown:
    'Wuu Browser hit an unexpected gateway error and could not classify it cleanly.',
}
